...
public class IoTApiServiceTests : IClassFixture<SmartHomeFixture>
{
    ...
    public async Task GetDevice_NoDeviceId_ShouldBeError()
    {
        ...
        await act.Should().ThrowExactlyAsync<ArgumentException>()
            .WithMessage("No Device Id provided *");
    }
    ...
    public async Task ManageDevices_NullRequest_ShouldThrow()
    {
        // arrange
        // act
        Func<Task> act = async () => await _ioTApiService.ManageDevicesAsync(_authToken, null);
    ...
    public async Task GetGroup_NullGroupId_ShouldThrow()
    {
        // arrange
        // act
        Func<Task> act = async () => await _ioTApiService.GetGroupAsync(_authToken, null);

        // assert
        await act.Should().ThrowExactlyAsync<ArgumentException>()
            .WithMessage("No Group Id provided *");
    }
    ...
    public async Task ManageGroup_NullGroupId_ShouldThrow()
    {
        ...
        // act
        Func<Task> act = async () => await _ioTApiService.ManageGroupAsync(_authToken, null, request);
    ...
    public async Task ManageGroup_NullRequest_ShouldThrow()
    {
        ...
        // act
        Func<Task> act = async () => await _ioTApiService.ManageGroupAsync(_authToken, groupId, null);
    ...
    public async Task ManageScenario_NullScenarioId_ShouldThrow()
    {
        // arrange
        // act
        Func<Task> act = async () => await _ioTApiService.ManageScenarioAsync(_authToken, null);

        // assert
        await act.Should().ThrowExactlyAsync<ArgumentException>()
            .WithMessage("No Scenario Id provided *");
    }
    ...
    {
        // arrange
        const string scenarioId = "unknown";
